...
describe("spheriod", () => {
    ...
    test("clampToSurface", () => {
        ...
        let mv_4326_clmap = SRS.transform(SRS.ECEF, SRS.WGS84, VEC3.array(mv_4978_clamp));
        expect(mv_4326_clmap[2]).toBeCloseTo(0, 6);

        mv_4978_clamp = s.clampToSurface(mv_4978, 100);
        mv_4326_clmap = SRS.transform(SRS.ECEF, SRS.WGS84, VEC3.array(mv_4978_clamp));
